...
>) {
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground flex items-center rounded-sm px-2 py-2 text-sm font-medium cursor-pointer outline-hidden select-none",
        className
      )}
      {...props}
    />
